...
curl -X POST -H "Content-type: application/json"  -u devopstrainingblr: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  -d "{\"title\": \"SSHKEY\"}" "https://api.github.com/user/keys?access_token=$token"
if [ $? -eq 0 ]
then 
